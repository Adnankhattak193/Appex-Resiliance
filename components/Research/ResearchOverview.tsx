        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <p className="text-textSecondary text-xl leading-relaxed mb-8">
              We conduct multi-hazard assessments, urban risk mapping,
              response-time analysis, cost-efficiency modeling, and
              institutional capacity evaluations
            </p>

            <div className="p-6 bg-[#F4F6F8] rounded-2xl border-l-4 border-accent">
              <p className="text-primary font-medium">
                These insights guide system architecture, fleet composition,
                training priorities, and command integration strategies.
              </p>
            </div>
          </motion.div>
          ...
          >
            <div className="bg-primary rounded-[2.5rem] p-10 text-white shadow-2xl relative z-10">
              ...
              <p className="text-white/80 text-lg leading-relaxed mb-8">
                Beyond technical analysis, we examine governance alignment,
                legislative readiness, and long-term sustainability indicators
                to ensure that reforms are both operationally sound and
