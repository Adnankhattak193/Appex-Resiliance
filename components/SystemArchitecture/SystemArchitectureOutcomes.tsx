...
const outcomes = [
  {
    title: "Integrated multi-agency coordination",
    icon: HeartPulse,
  },
  {
    title: "Optimized coverage and response density",
    icon: Timer,
  },
  {
    title: "Budget-controlled scalability ",
    icon: Handshake,
  },
  {
    title: "Institutional performance benchmarks ",
    icon: TrendingUp,
  },
  {
    title: "Long-term operational sustainability ",
    icon: ShieldCheck,
  },
];

export const SystemArchitectureOutcomes: React.FC = () => {
  return (
