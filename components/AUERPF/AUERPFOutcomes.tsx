...
const outcomes = [
  {
    title: "Measurable Reduction in Preventable Mortality",
    icon: HeartPulse,
  },
  {
    title: "Faster Urban Response Times",
    icon: Timer,
  },
  {
    title: "Structured Inter-Agency Coordination",
    icon: Handshake,
  },
  {
    title: "Budget-Aligned Scalability",
    icon: TrendingUp,
  },
  {
    title: "Institutional Capacity Transfer",
    icon: ShieldCheck,
  },
];

export const AUERPFOutcomes: React.FC = () => {
  return (
