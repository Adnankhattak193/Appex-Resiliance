...
import { EquipmentPageHeader } from "@/Public/images/Headers/Headers";

export const EquipmentHero: React.FC = () => {
  return (
    <section className="relative overflow-hidden bg-primary">
      ...
      <div className="min-[760px]:hidden relative h-[280px]">
        <div
          ...
          style={{ backgroundImage: `url(${EquipmentPageHeader})` }}
        />
      ...
      <div className="relative z-20 max-w-7xl mx-auto px-5 sm:px-6 w-full min-[760px]:min-h-[95vh] min-[760px]:grid min-[760px]:grid-cols-2 gap-12 min-[760px]:items-center pt-8 min-[760px]:pt-24 pb-24">
        ...
        >
          ...
          <p className="text-gray-300 text-base sm:text-lg mb-10 max-w-2xl leading-relaxed font-light">
            Selecting the right equipment is critical to building reliable
            emergency systems. ApexResilience guides governments and
            institutions in identifying, procuring, and installing
            fit-for-purpose solutions across EMS, Fire & Rescue, Disaster
            Management, Command & Control, training simulations, and hospitals.
            We combine operational insight, technical evaluation, and structured
            integration—ensuring every installation strengthens performance,
          ...
          <div className="flex flex-wrap gap-4">
            <Button
              variant="accent"
              className="px-8 py-4 rounded-full font-bold uppercase tracking-wider shadow-lg hover:shadow-accent/20 transition-all font-sans"
            >
              Request Technical Consultation
            </Button>
            <button className="px-8 py-4 rounded-full font-bold uppercase tracking-wider border border-white/20 text-white hover:bg-white/5 transition-all font-sans">
