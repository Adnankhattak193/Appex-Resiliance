...
import { CommandHeader } from "@/Public/images/Headers/SubHeaders/SubHeader";
      ...
      <div className="relative z-20 max-w-7xl mx-auto px-5 sm:px-6 w-full min-[760px]:min-h-[95vh] min-[760px]:grid min-[760px]:grid-cols-2 gap-12 min-[760px]:items-center pt-8 min-[760px]:pt-24 pb-24">
        ...
        >
          ...
          <p className="text-gray-300 text-base sm:text-lg mb-10 max-w-2xl leading-relaxed font-light">
            ...
            decision-makers into one coordinated structure — ensuring rapid,
            precise, and accountable response. ApexResilience builds these
            systems as institutional architecture, not just control rooms. We
            integrate dispatch protocols, multi-agency coordination, and
            performance intelligence within national governance frameworks —
