...
import { RUAAPHeader } from "@/Public/images/Headers/SubHeaders/SubHeader";

export const RUAAPHero: React.FC = () => {
  return (
    <section className="relative overflow-hidden bg-primary">
      ...
      <div className="min-[760px]:hidden relative h-[280px]">
        <div
          ...
          style={{ backgroundImage: `url(${RUAAPHeader})` }}
        />
