...
export const AUERPFCTA: React.FC = () => {
  return (
    <section className="py-24 bg-primary relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="bg-secondary/30 backdrop-blur-sm p-12 md:p-20 rounded-[3rem] border border-white/10 text-center">
          ...
          >
            Not a Project. A Transition Model.
          </motion.h2>
          ...
          >
            AUER-PF is not a project. It is a structured transition model —
            reshaping safety culture, strengthening public trust, and building
            resilient futures through system-based design.
          </motion.p>
        </div>
      </div>
    </section>
