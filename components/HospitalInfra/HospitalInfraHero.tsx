...
import { HospitalHeader } from "@/Public/images/Headers/SubHeaders/SubHeader";

export const HospitalInfraHero: React.FC = () => {
  return (
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute inset-0 opacity-60 mix-blend-overlay">
          ...
          <div
            ...
            style={{ backgroundImage: `url(${HospitalHeader})` }}
          ></div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-20 w-full lg:grid lg:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <p className="text-gray-300 text-base sm:text-lg mb-10 max-w-2xl leading-relaxed font-light">
            Hospitals function efficiently when infrastructure, workflow,
            equipment, and medical furniture operate as one system.
            ApexResilience designs complete or partial hospital environments,
            selecting appropriate technologies and planning logical
            installations around patient flow. We integrate space, equipment,
            and operations into sustainable, high-performance healthcare
            systems.
          </p>
