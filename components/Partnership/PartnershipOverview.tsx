        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <p className="text-textSecondary text-xl leading-relaxed mb-8">
              ApexResilience collaborates with governments, development
              partners, financial institutions, technology providers, training
              bodies, and local stakeholders to ensure that system design,
              funding logic, and operational execution move in alignment
            </p>

            <div className="p-6 bg-[#F4F6F8] rounded-2xl border-l-4 border-accent">
              <p className="text-primary font-medium">
                Each partnership is structured around accountability,
                performance benchmarks, and long-term sustainability.
              </p>
            </div>
          </motion.div>
          ...
          >
            <div className="bg-primary rounded-[2.5rem] p-10 text-white shadow-2xl relative z-10">
              ...
              <p className="text-white/80 text-lg leading-relaxed mb-8">
                We prioritize institutional strengthening over short-term
                visibility — ensuring knowledge transfer, local capacity
                development, and governance integration at every stage.
              </p>
            </div>
