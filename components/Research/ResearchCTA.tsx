...
export const ResearchCTA: React.FC = () => {
  return (
    <section className="py-24 bg-primary relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="bg-secondary/30 backdrop-blur-sm p-12 md:p-20 rounded-[3rem] border border-white/10 text-center">
          ...
          >
            Research & Insights convert information into institutional strength
            — reshaping safety culture and guiding nations toward resilient,
            secure futures
          </motion.p>
