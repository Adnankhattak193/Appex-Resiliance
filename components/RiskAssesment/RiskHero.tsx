...
import { FireSafetyHeader } from "@/Public/images/Headers/SubHeaders/SubHeader";
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute inset-0 opacity-60 mix-blend-overlay">
          ...
          <div
            ...
            style={{ backgroundImage: `url(${FireSafetyHeader})` }}
          ></div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-20 w-full lg:grid lg:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <h1 className="text-white text-4xl sm:text-5xl md:text-6xl font-bold mb-5 sm:mb-6 leading-[1.05]">
            <span className=""> Fire Safety & Risk Governance</span> <br />
          </h1>
          ...
          <p className="text-gray-300 text-base sm:text-lg mb-10 max-w-2xl leading-relaxed font-light">
            Fire safety goes beyond alarms and equipment — it is a governance
            system that protects lives, infrastructure, and institutional
            stability. ApexResilience designs prevention-driven frameworks
            integrating risk assessment, engineering standards, inspections, and
            regulatory compliance. We build structured, accountable fire risk
            architecture — not fragmented compliance exercises. <br />
