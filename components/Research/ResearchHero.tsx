...
import { ResearchHeader } from "@/Public/images/Headers/Headers";
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-20 w-full lg:grid lg:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <h2 className="text-white text-2xl md:text-3xl font-bold mb-6">
            Data-Informed Decisions. Future-Ready Systems.
          </h2>

          <div className="space-y-4 text-gray-300 text-lg mb-10 max-w-2xl leading-relaxed font-light">
            <p>
              Effective emergency governance must be built on evidence — not
              assumption. Research & Insights form the analytical backbone of
              ApexResilience system design
            </p>
            <p>
              ensuring that policies, investments, and deployment models are
              grounded in real risk patterns, demographic trends, and
              operational data.
            </p>
          </div>
        </motion.div>
