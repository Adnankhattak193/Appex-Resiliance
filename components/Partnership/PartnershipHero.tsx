...
import { PartnershipsHeader } from "@/Public/images/Headers/Headers";
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute inset-0 opacity-60 mix-blend-overlay">
          ...
          <div
            ...
            style={{ backgroundImage: `url(${PartnershipsHeader})` }}
          ></div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-20 w-full lg:grid lg:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <h1 className="text-white text-4xl sm:text-5xl md:text-6xl font-bold mb-5 sm:mb-6 leading-[1.05]">
            <span className="text-accent text-3xl sm:text-4xl underline decoration-accent/30 underline-offset-8">Partnerships </span>
          </h1>

          <h2 className="text-white text-2xl md:text-3xl font-bold mb-6">
            Aligned Interests. Shared Impact.
          </h2>

          <div className="space-y-4 text-gray-300 text-lg mb-10 max-w-2xl leading-relaxed font-light">
            <p>
              Transforming national emergency systems cannot be achieved in
              isolation. Partnerships form the strategic bridge between
              government vision, technical expertise, financial structuring, and
