...
import { SystemArchitectureHeader } from "@/Public/images/Headers/Headers";

export const SystemArchitectureHero: React.FC = () => {
  return (
    <section className="relative overflow-hidden bg-primary">
      ...
      <div className="min-[760px]:hidden relative h-[280px]">
        <div
          ...
          style={{ backgroundImage: `url(${SystemArchitectureHeader})` }}
        />
      ...
      <div className="relative z-20 max-w-7xl mx-auto px-5 sm:px-6 w-full min-[760px]:min-h-[95vh] min-[760px]:grid min-[760px]:grid-cols-2 gap-12 min-[760px]:items-center pt-8 min-[760px]:pt-24 pb-24">
        ...
        >
          ...
          <h2 className="text-white text-2xl md:text-3xl font-bold mb-6">
            Structured Design –{" "}
            <span className="text-accent text-3xl sm:text-4xl underline decoration-accent/30 underline-offset-8">Scalable Implementation</span>
          </h2>

          <div className="space-y-4 text-gray-300 text-lg mb-10 max-w-2xl leading-relaxed font-light">
            <p>
              Modern emergency systems cannot function on vehicles alone — they
              require architecture. System Architecture & Deployment Models
              define
            </p>
            <p>
              how Emergency Medical Services, Fire & Rescue, Command & Control,
              training institutions, and risk governance integrate into one
