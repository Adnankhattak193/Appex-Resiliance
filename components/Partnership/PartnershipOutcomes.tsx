...
const outcomes = [
  {
    title: "Coordinated multi-stakeholder execution ",
    icon: HeartPulse,
  },
  {
    title: "Sustainable financing pathways ",
    icon: Timer,
  },
  {
  ...
  {
    title: "Institutional capacity growth ",
    icon: TrendingUp,
  },
  {
    title: "Long-term public trust reinforcement ",
    icon: ShieldCheck,
  },
];

export const PartnershipOutcomes: React.FC = () => {
  return (
