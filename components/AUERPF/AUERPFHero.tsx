...
import { AUERPFHeader } from "@/Public/images/Headers/Headers";

export const AUERPFHero: React.FC = () => {
  return (
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute inset-0 opacity-60 mix-blend-overlay">
          ...
          <div
            ...
            style={{ backgroundImage: `url(${AUERPFHeader})` }}
          ></div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-20 w-full lg:grid lg:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <h2 className="text-white text-2xl md:text-3xl font-bold mb-6">
            Africa Urban Emergency Response –{" "}
            <span className="text-accent text-3xl sm:text-4xl underline decoration-accent/30 underline-offset-8">Pilot Framework</span>
          </h2>

          <div className="space-y-4 text-gray-300 text-lg mb-10 max-w-2xl leading-relaxed font-light">
            <p>
              AUER-PF is a structured pilot framework designed to help African
              cities transition from fragmented emergency response models to
              integrated, data-driven, and institutionally governed systems.
            </p>
            <p>
              It provides a controlled pathway for testing, refining, and
              scaling modern Emergency Medical, Fire & Rescue, and Command &
              Control capabilities within real urban environments.
            </p>
          </div>
        </motion.div>
