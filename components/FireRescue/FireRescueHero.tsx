...
import { FireRescueHeader } from "@/Public/images/Headers/SubHeaders/SubHeader";

export const FireRescueHero: React.FC = () => {
  return (
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute inset-0 opacity-60 mix-blend-overlay">
          ...
          <div
            ...
            style={{ backgroundImage: `url(${FireRescueHeader})` }}
          ></div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-20 w-full lg:grid lg:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <h2 className="text-white/80 text-lg md:text-xl font-medium mb-8 max-w-xl leading-relaxed">
            Architecting Resilience for Civil Protection
          </h2>

          <p className="text-gray-300 text-base sm:text-lg mb-10 max-w-2xl leading-relaxed font-light">
            Urban growth, industrial density, and climate pressure are reshaping
            fire risk. ApexResilience designs integrated Fire & Rescue systems
            that unify prevention, fleet structuring, training, and command
            coordination within a governance-aligned framework.
            <br />
            We don’t just supply fire engines — we build accountable, measurable
